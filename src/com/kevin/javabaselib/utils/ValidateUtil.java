...
public class ValidateUtil {
	...
	/**
	 * 定义电话号码的正则表达式 匹配格式�?11位手机号�?3-4位区号，7-8位直播号码，1�?位分机号
	 * �?12345678901�?234-12345678-1234
	 */
	...
	public static boolean isContainsHref(String text) {
		if (ValidateUtil.isNull(text))
			return false;
		Pattern pattern = Pattern.compile(StringUtils._HREF_URL_REGEX);
